...
-- =====================================================
-- Create the unit_whatsapp_connections table
...
$$ LANGUAGE plpgsql;
-- Create trigger
DROP TRIGGER IF EXISTS trigger_update_unit_whatsapp_updated_at ON unit_whatsapp_connections;
...
SELECT 'unit_whatsapp_connections table created successfully!' as message,
    COUNT(*) as row_count
